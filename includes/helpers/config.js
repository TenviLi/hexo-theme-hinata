...
module.exports = function(hexo) {
    ...
    hexo.extend.helper.register("get_config", function(
        configName,
        ...
        if (value === null) {
            if (typeof defaultValue !== "undefined") {
                ...
                return property === null
                    ? null
                    : property[descriptors.defaultValue];
            }
        }
        return value;
    });

    hexo.extend.helper.register("has_config", function(
        configName,
        excludePage = false
    ) {
    ...
    hexo.extend.helper.register("get_config_from_obj", function(
        object,
        configName,
        defaultValue = null
    ) {
